 ...
 * @author Ashish
 */
public class Workshop_CV extends javax.swing.JFrame {

    /**
     * Creates new form Workshop_CV
     */
    ...
    private void initComponents() {
        ...
        x3.setText("Fill Your Attendent Workshop details . (e.g. Competitive programming Workshop,");

        x5.setFont(new java.awt.Font("Calibri", 0, 24)); // NOI18N
        x5.setText("Matlab Workshop, etc... )");
        ...
        jButton10.setText("Add Workshop");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/workshop.jpg"))); // NOI18N
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        try{
            ...
            stmt.executeUpdate("INSERT INTO `workshop`(`UserId`, `Organization`, `Year`, `Discription`) VALUES ('"+userid+"','"+jTextField7.getText()+"','"+Integer.parseInt(jTextField8.getText())+"','"+jTextField5.getText()+"');");
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Workshop_CV.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Workshop_CV().setVisible(true);
            }
        });
    }
